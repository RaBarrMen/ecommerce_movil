...
// Constante del correo del administrador (Reemplázalo por tu email exacto)
    ...
    return Scaffold(
      body: CustomScrollView(
        slivers: [
              ...
              child: Card(
                child: Column(
                  children: [
                    ...
                    // ── [NUEVO] Preferencias de Notificaciones avanzadas (Temas FCM) ──
                    _SettingsTile(
                      icon: Icons.notifications_active_outlined,
                      label: 'Temas de notificación',
                      color: Colors.orange,
          ...
          // ── [NUEVO] Botón Condicional del Panel de Administrador ───────────────
